      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            <div className="overflow-hidden rounded-xl md:3xl max-w-[30rem] md:max-w-[35rem] max-h-[30rem] md:max-h-[35rem]">
              <img
            ...
            <div className="flex flex-wrap space-x-2 md:space-x-5 mt-4 justify-center">
              {product.images.map((item) => (
                <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-xl md:rounded-3xl  max-w-[4rem] md:max-w-[7rem] md:max-h-[7rem] max-h-[4rem]">
                  <img
                    alt={item.alt}
                    src={item.src}
                    className="h-full w-full object-cover object-center"
          ...
          {/* Product info */}
          <div className="lg:col-span-1 max-auto  max-w-2xl px-4 pb-16 sm:px-6 md:max-w-7xl md:px-8 md:pb-24">
            <div className="lg:col-span-2">
              <h1 className="text-lg md:text-xl font-semibold text-gray-900">
                Samsung
              </h1>
              <h1 className="text-lg md:text-xl opacity-70 text-gray-900">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex items-center space-x-3 mt-4">
                <Rating
                  ...
                  readOnly
                />
                <p className="opacity-70 text-sm font-medium text-indigo-500">
                  117 Reviews
                </p>
              </div>
              ...
              <form className="mt-10">
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    <span class="relative invisible">Add to Bag</span>
                  </a>
                </div>
              </form>
            </div>
